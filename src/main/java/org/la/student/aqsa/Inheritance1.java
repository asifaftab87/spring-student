...
public class Inheritance1 extends C {
	public static void main(String[] args) {
		    ...
		    B b = new C();
	     	b.methP3();
		    b.methC2();
	// 1st error	b.meth();      parent ref cant access child class method but vice versa is possible
		    System.out.println("  ");
		
		    A a1 = new C();
		    a1.methP3();
/*2nd error a1.methC1();  reference of class a can't access methodC1() which is in child class 
...
//3rd error B b1 = new A();  but vice versa is not possible
//		    a2.methC1();   
//	        a2.meth();
		    System.out.println("  ");
		    ...
		    A a3 = new A();
		    a3.methP3();
//		    a3.methC1();   //parent ref a3 of class A cant access  method of child B
//		    a3.methC2();   //parent ref a3 of class A cant access  method of child B
//		    a3.meth();     //parent ref a3 of class A cant access   method of child C
		    System.out.println("  ");
